(function (window, undefined) {
  ...
  AcceptCookie.prototype = {
    ...
    appendCss: function () {
      ...
      cssCode +=
        "#pjAcceptCookieBar { position: fixed; bottom: 0; left: 0; z-index: 9999; overflow-x: hidden; overflow-y: auto; max-width: 400px; max-height: 100%; padding: 10px 0; background: var(--footer-back-color); font-family: 'Roboto', sans-serif; text-align: left;}";
      cssCode +=
      ...
      cssCode +=
        "#pjAcceptCookieBar p { font-size: 14px; line-height: 1.4; color: #fff; font-weight: 400; }";
      cssCode +=
        "#pjAcceptCookieBar .pjAcceptCookieBarActions { padding-top: 10px; }";
      cssCode +=
        "#pjAcceptCookieBar .pjAcceptCookieBarBtn { position: relative; display: inline-block; height: 20px; padding: 0 30px; border: 0; background: var(--footer-nav-link-color-hover); transition: color .3s ease-in; font-size: 14px; line-height: 14px; color: #fff; text-decoration: none; vertical-align: middle; cursor: pointer; border-radius: 0; -webkit-appearance: none; -webkit-border-radius: 0; -webkit-transform: translateZ(0); transform: translateZ(0); -webkit-backface-visibility: hidden; backface-visibility: hidden; -moz-osx-font-smoothing: grayscale; }";
      cssCode += "#pjAcceptCookieBar .pjAcceptCookieBarBtn:hover,";
      cssCode +=
        "#pjAcceptCookieBar .pjAcceptCookieBarBtn:hover { background: var(--footer-copyright-color); transition: color .3s ease-in;}";
      cssCode +=
        "#pjAcceptCookieBar .pjAcceptCookieBarBtn:focus { text-decoration: none; }";
      cssCode +=
        "#pjAcceptCookieBar .pjAcceptCookieBarBtn:after { background: var(--footer-copyright-color); transition: color .3s ease-in;}";
    ...
    addCookieBar: function () {
      ...
      var htmlBar = "";
      htmlBar +=
        '<div class="pjAcceptCookieBarShell"><form action="#" method="post">';
      htmlBar +=
        "<p>Мы используем cookie. Продолжая пользоваться сайтом, вы соглашаетесь с использованием файлов cookie.</p>";
      htmlBar +=
        '<div class="pjAcceptCookieBarActions"><button type="button" class="pjAcceptCookieBarBtn">ОК</button></div></form></div>';
